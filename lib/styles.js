  ...
  getCartoCSS: function(table) {
    ...
    switch(table) {
      case 'core_indigenousland':
        ...
        cartocss += '#' + table + "[zoom>=12] { polygon-opacity: 0; text-fill: #fff; text-opacity: 0.8; text-name: [name]; text-face-name: 'DejaVu Sans Book'; text-halo-fill: #000; text-halo-radius: 1; text-placement-type: simple; text-placements: 'E,NE,SE,W,NW,SW'; text-size: 22; }";
